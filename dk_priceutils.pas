...
uses
  Classes, SysUtils, DK_StrUtils, Math;
  ...
  function PriceIntToString(const APrice: Int64; const ANeedThousandSeparator: Boolean = False): String;
  {1234.56 -> одна тысяча двести тридцать четыре рубля 56 копеек; AFirstCapital=true: первая буква заглавная}
  ...
  function PriceIntToText(const APrice: Int64; const AFirstCapital: Boolean = False): String;
